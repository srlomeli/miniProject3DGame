...
- **Concept:** This project extends a base endless runner. The player controls a "King" character who automatically runs forward on a path that is being generated by "chunks". The primary objective is survival. The player must dodge a variety of randomly spawned obstacles while collecting pickups like coins and apples to increase their score and speed to increase their remaining time at checkpoints. The game ends when the player's time runs out.
